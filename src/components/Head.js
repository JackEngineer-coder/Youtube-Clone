...
const Head = () => {
  return (
    ...
    <div className='grid grid-flow-col shadow-xl '>
        ...
        <img className='h-8 cursor-pointer' src="https://imgs.search.brave.com/zUc1MEiLVAkUFnzjhXQPRqPDS6baHazY1eCFNUOXrKk/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9zdGF0/aWMudmVjdGVlenku/Y29tL3N5c3RlbS9y/ZXNvdXJjZXMvdGh1/bWJuYWlscy8wMzkv/NjYzLzgyMC9zbWFs/bC9oYW1idXJnZXIt/bWVudS1iYXItZmxh/dC1pY29uLWZvci1h/cHBzLWFuZC13ZWJz/aXRlcy1mcmVlLXZl/Y3Rvci5qcGc"/>
